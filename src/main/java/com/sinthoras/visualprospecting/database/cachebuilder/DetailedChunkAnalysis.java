...
public class DetailedChunkAnalysis {
    ...
    private final Map<GT_Block_Ore, Integer>[] oresPerY = new HashMap[VP.minecraftWorldHeight];
...
//                    oresPerY[gtOre.blockY].put(gtOre., 0);
//                }
...
//        }
    ...
    public VeinType getMatchedVein() {
        ...
        final Map<GT_Block_Ore, Integer> allOres = new HashMap<>();
        for (Map<GT_Block_Ore, Integer> oreLevel : oresPerY) {
        ...
        final Optional<GT_Block_Ore> dominantOre = allOres.entrySet().stream()
